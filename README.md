### javascript
[理解浏览器和node.js中的Event loop事件循环](https://juejin.im/post/5ab88836f265da237410f701)
...
[node  JavaScript事件循环机制（event loop、macrotask、microtask）](https://www.cnblogs.com/dong-xu/p/7000139.html)
